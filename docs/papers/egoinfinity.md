...
![EgoInfinity 数据引擎：从互联网视频筛选、度量手物重建与交互修正到机器人部署](assets/egoinfinity-pipeline.png)
...
![EgoInfinity 根坐标系估计与跨本体运动重定向流程](assets/egoinfinity-retargeting.png)
...
![EgoInfinity 数据浏览、跨本体重定向、下游抓取策略与真实机器人实验](assets/egoinfinity-experiments.png)
